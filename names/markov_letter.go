...
// a time; a depth less than 1 is treated as 1. The data should be a map of names to a count which indicates how common
// the name is relative to others in the set. Any count less than 1 effectively removes the name from the set. If
...
// a run at a time; a depth less than 1 is treated as 1. The data should be a set of names to train the model with. If
// 'lowered' is true, then the result will be forced to lowercase. If 'firstToUpper' is true, then the result will have
// its first letter capitalized.
