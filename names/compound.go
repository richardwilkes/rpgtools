...
// 'namers'. Nil namers, including typed nil pointers, are ignored. If 'lowered' is true, then the result will be forced
// to lowercase. If 'firstToUpper' is true, then the result will have its first letter capitalized.
func NewCompoundNamer(separator string, lowered, firstToUpper bool, namers ...Namer) *CompoundNamer {
	// xreflect.IsNil also catches a typed nil pointer, which compares unequal to nil yet panics when used.
