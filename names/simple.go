...
// NewSimpleUnweightedNamer creates a new SimpleNamer. The data should be a list of names to choose from; a name that
// appears more than once is weighted accordingly. If 'lowered' is true, then the result will be forced to lowercase. If
// 'firstToUpper' is true, then the result will have its first letter capitalized.
